...
Generated: 2025-08-22T19:49:17Z
Nomad Endpoint: http://100.108.219.48:4646
Namespace: default
...
-   Affinities: null
    ...
    StatusDescription: ''
    Stop: false
    SubmitTime: 1755839903904346660
    TaskGroups:
    -   Affinities: null
        Constraints:
        -   LTarget: ${attr.nomad.version}
        ...
        -   Actions: null
            ...
            -   ChangeMode: restart
                ...
                EmbeddedTmpl: "# Static configuration\napi:\n  dashboard: true\n  debug:
                    true  # Enable debug for troubleshooting\n  insecure: true  #
                    Required for Traefik v3.0 to expose dashboard on admin entrypoint\n\nentryPoints:\n
                    \ web:\n    address: \":80\"\n    http:\n      redirections:\n
                    \       entryPoint:\n          to: websecure\n          scheme:
                    https\n          permanent: true\n\n  websecure:\n    address:
                    \":443\"\n\n  traefik:\n    address: \":8080\"  # Changed from
                    'admin' to 'traefik' to match standard convention\n\nproviders:\n
                    ...
                    \    prefix: traefik\n\nping:\n  entryPoint: traefik  # Updated
                    to match entrypoint name\n\nlog:\n  level: DEBUG  # More verbose
