...
-- Location: docs/implementation/powerdns/resources/powerdns-postgresql-schema.sql
--
-- This schema is embedded in the PostgreSQL Nomad job's init-pdns task.
-- Any changes made here should be reflected in the job template.

-- Create the database and user (handled separately by initialization)
...
-- These will be executed when connected to the powerdns database
