...
- **Deployed to doggos-homelab cluster in dev mode**:
  - nomad-server-1-lloyd: v1.15.5 at http://192.168.10.11:8200
  - nomad-server-2-holly: v1.20.1 at http://192.168.10.12:8200
  - nomad-server-3-mable: v1.20.1 at http://192.168.10.13:8200
