...
variable "fabio_consul_refresh" {
  type    = string
  default = "5s"
}

variable "fabio_proxy_strategy" {
  type    = string
  default = "rr"
}

variable "fabio_max_conn" {
  type    = number
  default = 10000
}

variable "fabio_dial_timeout" {
  type    = string
  default = "30s"
}

variable "fabio_read_timeout" {
  type    = string
  default = "30s"
}

variable "fabio_write_timeout" {
  type    = string
  default = "30s"
}

variable "fabio_metrics_target" {
  type    = string
  default = "stdout"
}

variable "fabio_metrics_prefix" {
  type    = string
  default = "fabio"
}

variable "fabio_metrics_interval" {
  type    = string
  default = "10s"
}

variable "fabio_ui_title" {
  type    = string
  default = "Homelab Load Balancer"
}

variable "fabio_routes" {
  type    = string
  default = ""
}
