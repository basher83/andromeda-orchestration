...
def run_module():
    ...
    preemption_config_spec = {
        "system_scheduler_enabled": {"type": "bool", "aliases": ["SystemSchedulerEnabled"], "default": True},
        "sys_batch_scheduler_enabled": {"type": "bool", "aliases": ["SysBatchSchedulerEnabled"], "default": False},
        "batch_scheduler_enabled": {"type": "bool", "aliases": ["BatchSchedulerEnabled"], "default": False},
        "service_scheduler_enabled": {"type": "bool", "aliases": ["ServiceSchedulerEnabled"], "default": False},
    }
    module_args = {
        ...
        "scheduler_algorithm": {"type": "str", "choices": ["binpack", "spread"], "default": "binpack"},
        ...
        "preemption_config": {"type": dict, "aliases": ["PreemptionConfig"], "options": preemption_config_spec},
    }
